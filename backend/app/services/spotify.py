...
def build_admin_redirect_uri() -> str:
    settings = get_settings()
    return f"{settings.public_base_url.rstrip('/')}/api/v1/admin/callback"
...
async def get_admin_authorize_url() -> tuple[str, str]:
    settings = get_settings()
    redirect_uri = build_admin_redirect_uri()
    params = {
