...
| **AI Model** | Google Gemini (gemini-2.0-flash-exp) | Generates contextual playlist recommendations based on user vibes. |
...
| POST | /api/v1/playlist/generate | Accepts a vibe string. Returns a list of 10 songs generated by Gemini AI. Does not require authentication. |
